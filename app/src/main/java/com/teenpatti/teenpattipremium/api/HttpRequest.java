...
public class HttpRequest
{
    ...
    public String doPostWithFilemultiple(String url, String filekey, String filepath,
                                         HashMap<String, String> valueMap, String videokey, String videopath) throws Exception
    {
        Log.e("","Photo Post start");
        HttpClient client = new DefaultHttpClient();
        client.getParams().setParameter(CoreProtocolPNames.PROTOCOL_VERSION, HttpVersion.HTTP_1_1);
        ...
        if (!filepath.equals(""))
        {
            ...
            entity.addPart(videokey, new FileBody(new File(videopath),"video/mp4"));
